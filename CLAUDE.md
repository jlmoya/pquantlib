...
- **Phase:** **Phase 7 complete** — inflation cluster (opt-in extension beyond `pquantlib-final`). Tagged `pquantlib-phase7-complete` @ `3a7228e`.
- **Branch:** `main`. No active feature branches.
- **Workspace:** uv-managed 4-package monorepo. Dependencies: numpy, scipy, pytest, pyright, ruff. No new deps in Phase 7.
- **Python:** 3.14. **Type checker:** pyright strict. **Lint+format:** ruff. **Test framework:** pytest 9+, **currently 2109/0/0**.
