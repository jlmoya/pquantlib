"""JpyLiborSwapIsdaFixAm — JPY LIBOR ISDA-Fix AM swap index.

# C++ parity: ql/indexes/swap/jpyliborswap.{hpp,cpp} (v1.43)

ISDA-Fix AM swap quoted at 10am Tokyo: semi-annual Actual/Actual (ISDA)
...
class JpyLiborSwapIsdaFixAm(SwapIndex):
    """JPY LIBOR ISDA-Fix AM (Semi-annual Act/Act ISDA vs 6M JPY LIBOR)."""
