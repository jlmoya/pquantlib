"""Cross-validate Malta holidays for 2020-2030 against the C++ v1.43 probe.

Probe key: time/calendars/all -> "malta". This calendar is new in C++ v1.43.
"""
...
from pquantlib.time.calendars.malta import Malta
...
def test_name_matches_cpp(cpp: dict[str, Any]) -> None:
    assert Malta().name() == cpp["malta"]["name"]
