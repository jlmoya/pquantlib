"""Cross-validate Serbia holidays for 2020-2030 against the C++ v1.43 probe.

Probe key: time/calendars/all -> "serbia". This calendar is new in C++ v1.43.
"""
...
from pquantlib.time.calendars.serbia import Serbia
...
def test_name_matches_cpp(cpp: dict[str, Any]) -> None:
    assert Serbia().name() == cpp["serbia"]["name"]
