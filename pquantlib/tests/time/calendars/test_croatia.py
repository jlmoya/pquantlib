"""Cross-validate Croatia holidays for 2020-2030 against the C++ v1.43 probe.

Probe key: time/calendars/all -> "croatia". This calendar is new in C++ v1.43.
"""
...
from pquantlib.time.calendars.croatia import Croatia
...
def test_name_matches_cpp(cpp: dict[str, Any]) -> None:
    assert Croatia().name() == cpp["croatia"]["name"]
